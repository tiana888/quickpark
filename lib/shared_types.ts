...
export type GetSpacesResponse = SpaceData[];

export type GetSpaceResponse = SpaceData;

export type CreateSpacePayload = Omit<SpaceData, "id">;

export type CreateSpaceResponse = Pick<SpaceData, "id">;
